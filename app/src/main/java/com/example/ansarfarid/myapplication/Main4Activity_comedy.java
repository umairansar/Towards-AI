...
public class Main4Activity_comedy extends AppCompatActivity {

    MyDataBase myDataBase;
    ListView lv;
    String Table = "COMEDY_TABLE";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main4_comedy);

        android.support.v7.app.ActionBar actionBar = getSupportActionBar();


        lv = (ListView) findViewById(R.id.listview_comedy);
    ...
    public void display(){
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Main4Activity_comedy.this, VideoPlayer.class);
