...
public class Main3Activity_drama extends AppCompatActivity {

    MyDataBase myDataBase;
    ListView lv;
    String Table = "DRAMA_TABLE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv = (ListView) findViewById(R.id.listview_dra);
    ...
    public void display(){
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Main3Activity_drama.this, VideoPlayer.class);
